...
DGM <- function(N,rho){
  ...
  y0 <- rnorm(n = N, mean = (0.5*x[,1] + 2*x[,7] + 3*x[,10]))
...
bias_x1 <- abs((sum(abs(Results0$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results1$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results2$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results3$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results4$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results5$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results6$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results7$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results8$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results9$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results10$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results11$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results12$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results13$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results14$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results15$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results16$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results17$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results18$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results19$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results20$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results21$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results22$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results23$x1))/total_row) - 0.5)
...
bias_x1 <- abs((sum(abs(Results24$x1))/total_row) - 0.5)
